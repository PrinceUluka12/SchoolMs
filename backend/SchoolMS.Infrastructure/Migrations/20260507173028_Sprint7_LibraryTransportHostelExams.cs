...
{
    /// <inheritdoc />
    public partial class Sprint7_LibraryTransportHostelExams : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    WardenId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HostelBuildings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HostelBuildings_Staff_WardenId",
                        column: x => x.WardenId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Staff_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookLoans_Staff_IssuedById",
                        column: x => x.IssuedById,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookLoans_Users_BorrowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HostelRooms_HostelBuildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "HostelBuildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MorningPickupFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    AfternoonDropFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamSeatingArrangements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamSeatingArrangements_ExamSchedules_ExamScheduleId",
                        column: x => x.ExamScheduleId,
                        principalTable: "ExamSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamSeatingArrangements_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HostelAllocations_Terms_TermId",
                        column: x => x.TermId,
                        principalTable: "Terms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermId = table.Column<Guid>(type: "uuid", nullable: false),
                    PickupStop = table.Column<string>(type: "text", nullable: false),
                    DropStop = table.Column<string>(type: "text", nullable: false),
                    Type = table.Column<string>(type: "text", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentTransports_Terms_TermId",
                        column: x => x.TermId,
                        principalTable: "Terms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSeatingArrangements_ExamScheduleId_StudentId",
                table: "ExamSeatingArrangements",
                columns: new[] { "ExamScheduleId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamSeatingArrangements_StudentId",
                table: "ExamSeatingArrangements",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HostelAllocations_StudentId_TermId",
                table: "HostelAllocations",
                columns: new[] { "StudentId", "TermId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HostelAllocations_TermId",
                table: "HostelAllocations",
                column: "TermId");

            migrationBuilder.CreateIndex(
                name: "IX_HostelBuildings_WardenId",
                table: "HostelBuildings",
                column: "WardenId");

            migrationBuilder.CreateIndex(
                name: "IX_HostelRooms_BuildingId",
                table: "HostelRooms",
                column: "BuildingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTransports_StudentId_RouteId_TermId",
                table: "StudentTransports",
                columns: new[] { "StudentId", "RouteId", "TermId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentTransports_TermId",
                table: "StudentTransports",
                column: "TermId");
